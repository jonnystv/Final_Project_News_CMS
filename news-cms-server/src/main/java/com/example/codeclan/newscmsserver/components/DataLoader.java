...
public class DataLoader implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) {
        ...
        AllArticles NEWS_CMS = new AllArticles("News CMS");
        ...
        Category cat3 = new Category("Health", article1);
        categoryRepository.save(cat3);
        Category cat4 = new Category("Environment", article1);
        ...
        NEWS_CMS.addArticle(article1);
        NEWS_CMS.addArticle(article2);
        NEWS_CMS.addArticle(article3);
        NEWS_CMS.addArticle(article4);
        NEWS_CMS.addArticle(article5);
        NEWS_CMS.addArticle(article6);
        NEWS_CMS.addArticle(article7);
        NEWS_CMS.addArticle(article8);
        allArticlesRepository.save(NEWS_CMS);
